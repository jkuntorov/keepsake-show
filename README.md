...
There are two kinds of tests in the keepsake-show application: Unit tests and End to End tests.

### Running Unit Tests

The keepsake-show app comes preconfigured with unit tests. These are written in
...
The keepsake-show app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
In addition, since Protractor is built upon WebDriver we need to install this.  The keepsake-show
